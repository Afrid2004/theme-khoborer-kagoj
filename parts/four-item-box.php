     ...
     <div class="row">
       ...
       <div class="col-md-3 col-12 border-end mt-md-0 mt-4">
         ...
         <div class="row">
           <div class="col-12 mt-md-3 mt-2">
             <?php 
                $niramoy = new WP_Query(array(
                    'cat' => $category_id,
                    'posts_per_page' => 1,
                    'order' => 'DESC'
                ));
                while ($niramoy->have_posts()):$niramoy->the_post();
            ?>
             <div class="border-bottom">
               <div class="row">
                 <div class="col-12">
       ...
       <div class="col-md-3 col-12 border-end mt-md-0 mt-4">
         ...
         <div class="row">
           <div class="col-12 mt-md-3 mt-2">
             <?php 
                $islam = new WP_Query(array(
                    'cat' => $category_id,
                    'posts_per_page' => 1,
                    'order' => 'DESC'
                ));
                while ($islam->have_posts()):$islam->the_post();
            ?>
             <div class="border-bottom">
               <div class="row">
                 <div class="col-12">
       ...
       <div class="col-md-3 col-12 mt-md-0 mt-4">
         ...
         <div class="row">
           <div class="col-12 mt-md-3 mt-2">
             <?php 
                $ArtCulture = new WP_Query(array(
                    'cat' => $category_id,
                    'posts_per_page' => 1,
                    'order' => 'DESC'
                ));
                while ($ArtCulture->have_posts()):$ArtCulture->the_post();
            ?>
             <div class="border-bottom">
               <div class="row">
                 <div class="col-12">
