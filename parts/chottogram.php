...
<div class="container fluid px-0">
  <div class="container">
    ...
    <div class="row border-bottom pb-3">
      <?php
      $ctgPart = new WP_Query(array(
        'cat' => $category_id,
        'posts_per_page' => 4,
        'order' => 'DESC'
      ));
      while ($ctgPart->have_posts()):$ctgPart->the_post();
    ?>
      <div class="col-md-3 col-12 col-6 mt-md-4 mt-3 mt-md-4 border-end border-last-none">
        <div class="image">
        ...
        <p class="lh-base d-md-block d-none"><?php $ctgText = get_the_content();
                                        $ctgTrimingWords = WP_trim_words($ctgText, 10, '...');
                                        echo $ctgTrimingWords;?></p>
