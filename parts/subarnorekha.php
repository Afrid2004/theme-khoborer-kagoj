...
<div class="container-fluid px-0">
  <div class="container border-bottom pb-md-4 pb-2">
    ...
    <div class="row">
      <?php 
                $subornorekha = new WP_Query(array(
                    'cat' => $category_id,
                    'posts_per_page' => 4,
                    'order' => 'DESC'
                ));
                while ($subornorekha->have_posts()):$subornorekha->the_post();
                ?>
      <div class="col-md-3 mt-4 border-end border-last-none">
        <div class="image">
        ...
        <div class="news-body d-none d-md-block">
          <p class="lh-base"><?php $subornoText = get_the_content();
                                        $subornoTrimingWords = WP_trim_words($subornoText, 10, '...');
                                        echo $subornoTrimingWords;?></p>
        </div>
