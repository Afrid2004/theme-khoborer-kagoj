...
function media_theme_css_js(): void {
    ...
    wp_enqueue_style('school-theme-style-css',get_stylesheet_directory_uri() . '/assets/css/style.css',array('lightgallery-bundle-min-css'),filemtime(get_stylesheet_directory() . '/assets/css/style.css'),'all');
