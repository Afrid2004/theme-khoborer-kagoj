...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="single.html">
                ...
                <div class="col-3">
                    <div class="border border-color rounded px-4 py-2">
                        <p class="mb-0 d-flex justify-content-center"><a
                                class="text-danger font-size-12 text-decoration-none" href="#">English</a></p>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-danger mt-md-3 d-none d-md-block">
        <div class="container px-0">
            <div class="row">
                ...
                <div class="col-md-1 pe-0 d-flex align-items-center d-md-block">
            ...
            <div class="col-12 pe-4">
                <div class="row d-flex align-items-center border-bottom pb-3">
                    <div class="col-md-12 px-4 px-sm-3">
                        <a class="text-decoration-none text-dark font-size-20 text-bold" href="index.html"> <i class="bi bi-house-door me-3"></i> জাতীয়</a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-12 border-end">
                    <div class="col-12">
                        <div class="heading">
                            <h1><a class="text-decoration-none text-dark" href="single.html">সুষ্ঠু নির্বাচন করতে সবার সহযোগিতা প্রয়োজন: স্বরাষ্ট্র উপদেষ্টা</a></h1>
                        </div>
                        ...
                        <div class="news-page-body">
                            <p class="font-size-18">সুষ্ঠু নির্বাচন শুধু আইনশৃঙ্খলা রক্ষাকারী বাহিনীর ওপর নির্ভর করে না, এ জন্য জনগণ, রাজনৈতিক দল, নির্বাচন কমিশনসহ সব স্টেকহোল্ডারদের সহযোগিতা প্রয়োজন বলে জানিয়েছেন স্বরাষ্ট্র উপদেষ্টা লেফটেন্যান্ট জেনারেল (অব.) মো. জাহাঙ্গীর আলম চৌধুরী। <br><br>

রবিবার (৭ সেপ্টেম্বর) রাজধানীর রাজারবাগে পুলিশ সদস্যদের নির্বাচন বিষয়ক প্রশিক্ষণ উদ্বোধনের সময় এ কথা বলেন তিনি। <br><br>

পুলিশকে ২০১৪, ১৮ ও ২৪ সালের নির্বাচন প্রক্রিয়া  ভুলে যেতে হবে মন্তব্য করে স্বরাষ্ট্র উপদেষ্টা বলেন, আশা করব নির্বাচন শান্তি ও উৎসবমুখর হবে। অতীতের বাজে নির্বাচনগুলোর কথা মাথা থেকে ফেলে দিতে হবে।  <br><br>

রাজনৈতিক দলের কাছ থেকে পুলিশকে দূরে থাকার পরামর্শ দিয়ে স্বরাষ্ট্র উপদেষ্টা বলেন, ধৈর্য্যের সঙ্গে মাথা ঠাণ্ডা রেখে আইনি প্রক্রিয়ায় সকল বিষয় মোকাবিলা করতে হবে। আমরা কাজ কর্মে যত স্বচ্ছ থাকবো সাধারণ জনগণের কাছে তত আস্থা অর্জন করতে পারব। <br><br>

যত বাধাই আসুক না কেন, নির্বাচনের আগে লটারির মাধ্যমে কর্মকর্তাদের পোস্টিং করা হবে বলেও জানান মো. জাহাঙ্গীর আলম চৌধুরী।</p>
                        </div>
                        <!-- social-media start -->
                        <div class="col-md-6 col-12 mt-md-4 mt-3">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 mt-4">
                ...
                <div class="heading">
                    <h6 class="mt-3 lh-base"><a class="text-decoration-none text-dark font-size-20" href="#">ক্যাডেট কলেজে ভর্তি পরীক্ষার প্রস্তুতি: বাংলা বিষয়</a></h6>
                </div>    
            </div>
            <div class="col-md-3 mt-4">
                <div class="image">
    ...
    <!-- footer part start -->
    <div class="container-fluid footer-bg-color mt-md-5 py-5 d-md-none">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="address text-align-justify mt-md-5 mt-3 text-center">
                        <p>১১৫ কাজী নজরুল ইসলাম এভিনিউ, লেভেল-১৩, বাংলামোটর, ঢাকা-১০০০ থেকে প্রকাশক মোস্তফা কামাল কর্তৃক
                            প্রকাশিত। স্কাইব্রিজ প্রিন্টিং এন্ড প্যাকেজিং লিমিটেড, ৭/এ/১ তেজগাঁও শিল্প এলাকা, ঢাকা থেকে
                            মুদ্রিত।</p>
                    </div>
                </div>
            </div>
    ...
    <!-- footer part start -->
    <div class="container-fluid footer-bg-color py-5 d-none d-md-block">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="logo-footer">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end warp-flex mt-md-4 mt-3">
                            <div class="pt-2 pb-2 d-flex justify-content-end flex-wrap font-md social-icon-box">
                                <div class="faceboo social-icon-width d-flex justify-content-end align-items-center"><a class="text-decoration-none" href="https://www.facebook.com/"><i class="bi bi-facebook font-size-22"></i> Facebook</a></div>
                                <div class="youtub social-icon-width d-flex justify-content-end align-items-center"><a class="text-decoration-none" href="https://www.facebook.com/"><i class="bi bi-youtube font-size-22"></i> Youtube</a></div>
                                <div class="youtub social-icon-width d-flex justify-content-end align-items-center"><a class="text-decoration-none" href="https://www.facebook.com/"><i class="bi bi-instagram font-size-22"></i></i> Instagram</a></div>
                                <div class="youtub social-icon-width d-flex justify-content-end align-items-center"><a class="text-decoration-none" href="https://www.facebook.com/"><i class="bi bi-linkedin font-size-22"></i> Linkedin</a></div>
                            </div>
                        </div>
                    </div>
                    <!-- social-media end -->
